...
var pathRegexp = __webpack_require__(105);
...
var _VERSION_STRING = __webpack_require__(147).version;
...
const methodOverride = __webpack_require__(127);

const path = __webpack_require__(0);

const serverless = __webpack_require__(134);

const app = express();
const router = express.Router(); // Template Settings

app.set("views", path.join(`${__dirname}src/views`));
app.engine('ejs', __webpack_require__(61).__express); // Middleware

router.use(bodyParser.json());
router.use(bodyParser.urlencoded({
  extended: false
}));
router.use(methodOverride()); // router.use('/public', express.static('./dist/public'));

router.use(__webpack_require__(148)); // Routes
...
router.use(__webpack_require__(156));
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(42).concat(__webpack_require__(89)) },
...
var Router = __webpack_require__(48);
var methods = __webpack_require__(23);
var middleware = __webpack_require__(106);
...
function View(name, options) {
  ...
  if (!opts.engines[this.ext]) {
    ...
    var fn = __webpack_require__(108)(mod).__express
...
var debug = __webpack_require__(128)('method-override')
var methods = __webpack_require__(23)
var parseurl = __webpack_require__(9)
var querystring = __webpack_require__(27)
var vary = __webpack_require__(58)
...
const finish = __webpack_require__(135);
const getFramework = __webpack_require__(136);
const getProvider = __webpack_require__(137);
...
const aws = __webpack_require__(138);
...
const cleanUpEvent = __webpack_require__(139);

const createRequest = __webpack_require__(140);
const formatResponse = __webpack_require__(142);
...
const Request = __webpack_require__(141);
...
const isBinary = __webpack_require__(143);
const Response = __webpack_require__(60);
const sanitizeHeaders = __webpack_require__(144);
...
const setCookieVariations = __webpack_require__(145).variations;
...
const PrismicConfig = __webpack_require__(153);

const PrismicDOM = __webpack_require__(62);
...
var fetchNode = __webpack_require__(150)
...
var nodeFetch = __webpack_require__(151)
...
const ejs = __webpack_require__(61);
